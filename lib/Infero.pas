...
/// </param>
procedure GetCursorPos(X, Y: PInteger); cdecl; external INFERO_DLL;
...
///   The Y position of the cursor.
/// </param>
procedure SetCursorPos(const X, Y: Integer); cdecl; external INFERO_DLL;

/// <summary>
///   Clears the current console screen.
/// </summary>
procedure ClearConsole(); cdecl; external INFERO_DLL;
...
/// </summary>
procedure ClearKeyStates(); cdecl; external INFERO_DLL;
...
/// </returns>
function IsKeyPressed(AKey: Byte): Boolean; cdecl; external INFERO_DLL;
...
/// </returns>
function WasKeyReleased(AKey: Byte): Boolean; cdecl; external INFERO_DLL;
...
/// </returns>
function WasKeyPressed(AKey: Byte): Boolean; cdecl; external INFERO_DLL;
...
procedure Pause(const AForcePause: Boolean=False; AColor: WORD=FG_WHITE;
  const AText: PWideChar=nil); cdecl; external INFERO_DLL;

/// <summary>
///   Processes Windows messages.
/// </summary>
procedure ProcessMessages(); cdecl; external INFERO_DLL;
...
/// </returns>
function FinalizeTokenResponse(): Boolean; cdecl; external INFERO_DLL;
...
procedure SetSpeechWordCallback(const AHandler: SpeechWordCallback;
  const AUserData: Pointer); cdecl; external INFERO_DLL;
...
/// </returns>
function GetSpeechVoiceCount(): Integer; cdecl; external INFERO_DLL;
...
function GetSpeechVoiceAttribute(const AIndex: Integer;
  const AAttribute: Byte): PWideChar; cdecl; external INFERO_DLL;
...
/// </returns>
function GetSpeechVoice(): Integer; cdecl; external INFERO_DLL;
...
/// </returns>
function GetSpeechVolume(): Single; cdecl; external INFERO_DLL;
...
///   The rate to set.
/// </param>
procedure SetSpeechRate(const ARate: Single); cdecl; external INFERO_DLL;
...
///   The current rate.
/// </returns>
function GetSpeechRate(): Single; cdecl; external INFERO_DLL;

/// <summary>
///   Clears the current speech voice.
/// </summary>
procedure ClearSpeech(); cdecl; external INFERO_DLL;
...
/// </returns>
function IsSpeechActive(): Boolean; cdecl; external INFERO_DLL;

/// <summary>
///   Pauses the current speech voice.
/// </summary>
procedure PauseSpeech(); cdecl; external INFERO_DLL;

/// <summary>
///   Resumes the current speech voice.
/// </summary>
procedure ResumeSpeech(); cdecl; external INFERO_DLL;

/// <summary>
///   Resets the current speech voice.
/// </summary>
procedure ResetSpeech(); cdecl; external INFERO_DLL;
...
/// </summary>
procedure ClearError(); cdecl; external INFERO_DLL;
...
/// </param>
procedure SetError(const AText: PWideChar); cdecl; external INFERO_DLL;
...
/// </returns>
function GetError(): PWideChar; cdecl; external INFERO_DLL;
...
/// </returns>
function GetInfoCallback(): InfoCallback; cdecl; external INFERO_DLL;
...
procedure InitConfig(const AModelPath: PWideChar;
  const ANumGPULayers: Int32); cdecl; external INFERO_DLL;
...
/// </summary>
procedure ClearAllMessages(); cdecl; external INFERO_DLL;
...
/// </returns>
function GetLastUserMessage(): PWideChar; cdecl; external INFERO_DLL;
...
function BuildMessageInferencePrompt(
  const AModelName: PWideChar): PWideChar; cdecl; external INFERO_DLL;

/// <summary>
///   Clears all model definitions.
/// </summary>
procedure ClearModelDefines(); cdecl; external INFERO_DLL;
...
function DefineModel(const AModelFilename, AModelName: PWideChar;
  ...
  ATemplateEnd: PWideChar): Int32; cdecl; external INFERO_DLL;
...
/// </returns>
function IsModelLoaded(): Boolean; cdecl; external INFERO_DLL;

/// <summary>
///   Unloads the currently loaded model.
/// </summary>
procedure UnloadModel(); cdecl; external INFERO_DLL;
...
function RunInference(const AModelName: PWideChar;
  const AMaxTokens: UInt32): Boolean; cdecl; external INFERO_DLL;
...
/// </returns>
function GetInferenceResponse(): PWideChar; cdecl; external INFERO_DLL;
...
procedure GetInferenceStats(ATokenInputSpeed: PSingle;
  ...
  ATotalTokens: PInt32); cdecl; external INFERO_DLL;
